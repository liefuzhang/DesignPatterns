...
namespace Coding.Exercise {
    ...
    public class RealDiscriminantStrategy : IDiscriminantStrategy {
        ...
        public double CalculateDiscriminant(double a, double b, double c) {
            return b * b < 4 * a * c ? Double.NaN : b * b - 4 * a * c;
        }
    }
    ...
    public class QuadraticEquationSolver {
        ...
        public Tuple<Complex, Complex> Solve(double a, double b, double c) {
            ...
            if (discriminant < 0) {
                ...
                return new Tuple<Complex, Complex>(new Complex(-b / 2 * a, imaginary / 2 * a), new Complex(-b / 2 * a, -imaginary / 2 * a));
            }

            return new Tuple<Complex, Complex>((-b + Math.Sqrt(discriminant)) / 2 * a, (-b - Math.Sqrt(discriminant)) / 2 * a);
        }
