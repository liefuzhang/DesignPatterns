...
namespace DotNetDesignPatternDemos.Behavioral.Observer.WeakEventPattern {
    ...
    public class Window {
        public Window(Button button) {
            button.Clicked += ButtonOnClicked; // this creates a reference from the button to this Window
        }
        ...
        // another way is to implement IDisposable and unsubscribe from button.Clicked
