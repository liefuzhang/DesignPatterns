...
namespace DotNetDesignPatternDemos.Behavioral.Visitor.Classic {
    ...
    public class DoubleExpression : Expression {
        ...
        public override void Accept(IExpressionVisitor visitor) {
            // double dispatch: which method to call depends on type of "this: expression and type of visitor
            visitor.Visit(this);
        }
    }
    ...
    public class ExpressionPrinter : IExpressionVisitor {
        ...
        // still breaks open-closed principle
        // but much better now, as we get compile time error if missing a Visit method for an expression
