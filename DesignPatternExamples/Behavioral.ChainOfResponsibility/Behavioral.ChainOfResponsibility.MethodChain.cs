...
namespace DotNetDesignPatternDemos.Behavioral.ChainOfResponsibility.MethodChain
{
  ...
  public class CreatureModifier // acts as the base class
  {
    protected Creature creature;
    protected CreatureModifier next; // a linked list of CreatureModifier
    ...
    public void Add(CreatureModifier cm) // this will add the modifier to the end of the linked list
    {
  ...
  public class DoubleAttackModifier : CreatureModifier
  {
    ...
    { 
      ...
      creature.Attack *= 2; // one drawback here is that this changes the creature Attack directly
      base.Handle();
    }
  }
