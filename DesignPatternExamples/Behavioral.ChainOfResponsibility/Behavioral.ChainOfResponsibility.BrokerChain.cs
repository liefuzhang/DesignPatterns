...
namespace DotNetDesignPatternDemos.Behavioral.ChainOfResponsibility.ModifierChain.BrokerChain
{
    ...
    public abstract class CreatureModifier : IDisposable
    {
        ...
        protected CreatureModifier(Game game, Creature creature)
        {
            ...
            game.Queries += Handle; // subscribe to the Queries event
        }
    ...
    public class DoubleAttackModifier : CreatureModifier
    {
        ...
        {
            // if the modifier's target creature is the queried-against creature, double the query value if it's attack query
